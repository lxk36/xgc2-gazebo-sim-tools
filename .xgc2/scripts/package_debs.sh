...
visualization_dep="ros-noetic-xgc2-gazebo-sim-visualization (>= 1.1.0-6)"
vrpn_bridge_dep="ros-noetic-xgc2-gazebo-sim-vrpn-bridge (>= 1.1.0-6)"

build_ros_package_deb \
  "${manager_pkg}" \
  "gazebo_session_manager" \
  "${vrpn_bridge_dep}, ${worlds_pkg} (>= 1.1.0-7), ros-noetic-rospy, ros-noetic-roslaunch, ros-noetic-rosnode, ros-noetic-gazebo-msgs, ros-noetic-gazebo-ros, ros-noetic-geometry-msgs, ros-noetic-controller-manager-msgs, ros-noetic-std-srvs" \
  "XGC2 Gazebo Classic session manager and WebUI tools"

build_ros_package_deb \
  "${examples_pkg}" \
  "gazebo_sim_examples" \
  "${visualization_dep}, ${vrpn_bridge_dep}, ${worlds_pkg} (>= 1.1.0-7), ros-noetic-xgc2-gazebo-sim-fs150-sitl, ros-noetic-xgc2-gazebo-sim-scout, ros-noetic-xgc2-multirotor-controller (>= 1.1.15-9), ros-noetic-xgc2-ugv-controller (>= 1.1.1-6), ros-noetic-xgc2-estimator-hover-thrust (>= 1.1.22-6), ros-noetic-xgc2-estimator-rigid-state (>= 1.1.3-8), ros-noetic-xgc2-vrpn-router, ros-noetic-vrpn-client-ros, ros-noetic-mavros, ros-noetic-mavros-msgs, ros-noetic-geometry-msgs, ros-noetic-nav-msgs, ros-noetic-rospy, ros-noetic-roslaunch" \
