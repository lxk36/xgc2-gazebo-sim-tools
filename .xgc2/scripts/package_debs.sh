...
build_ros_package_deb \
  "${examples_pkg}" \
  "gazebo_sim_examples" \
  "${visualization_dep}, ${vrpn_bridge_dep}, ${worlds_pkg} (>= 1.1.0-10), ros-noetic-xgc2-gazebo-sim-fs150-sitl (>= 1.1.0-10), ros-noetic-xgc2-gazebo-sim-scout (>= 0.4.9-23), ros-noetic-xgc2-multirotor-controller (>= 1.1.18-4), ros-noetic-xgc2-ugv-controller (>= 1.1.4-9), ros-noetic-xgc2-estimator-hover-thrust (>= 1.1.24-6), ros-noetic-xgc2-estimator-rigid-state (>= 1.1.6-6), xgc2-vrpn-router (>= 0.1.0-4+focal), ros-noetic-vrpn-client-ros, ros-noetic-mavros, ros-noetic-mavros-msgs, ros-noetic-geometry-msgs, ros-noetic-nav-msgs, ros-noetic-rospy, ros-noetic-roslaunch" \
